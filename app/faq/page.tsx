...
const FAQS = [
  ...
  {
    q: "هل التسجيل مجاني؟",
    a: "نعم، يمكن إنشاء حساب مجاني بدون بطاقة بنكية. الخطة المجانية مناسبة للتجربة وتصفح الموارد المتاحة.",
  },
  {
    q: "كيف يمكن الاشتراك في خطة بلوس أو بريميوم؟",
    a: "بلوس يتم تفعيلها حالياً يدوياً عبر WhatsApp بعد توضيح ما هو متاح فعلياً. بريميوم قيد الإعداد ولن يتم بيعها حتى تكتمل ميزاتها.",
  },
  {
    q: "هل الدروس مناسبة للمنهج المغربي؟",
    a: "الدروس منظمة حسب مستويات الإعدادي المغربي، وكل مورد يظهر مع حالة تحقق واضحة. الموارد غير المؤكدة تبقى موسومة كـ قيد المراجعة.",
  },
  {
    q: "هل يمكن لولي الأمر متابعة التقدم؟",
    a: "ميزة تقارير الأولياء قيد الإعداد. حالياً يمكن التواصل عبر WhatsApp للحصول على توجيه ومساعدة في استعمال المنصة.",
  },
  {
