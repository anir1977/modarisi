...
export const metadata: Metadata = {
  ...
  description:
    "موديريسي هي منصة تعلم لتلاميذ الإعدادي في المغرب. دروس منظمة، تمارين، امتحانات موحدة، ومساعد تعليمي باللغة العربية والفرنسية.",
  keywords: [
  ...
  openGraph: {
    title: "موديريسي — منصة التعلم للإعدادي المغربي",
    description: "دروس منظمة، تمارين، امتحانات موحدة، ومساعد تعليمي لتلاميذ الإعدادي المغربي.",
  ...
  twitter: {
    ...
    title: "موديريسي — منصة التعلم للإعدادي المغربي",
    description: "دروس منظمة، تمارين، امتحانات موحدة، ومساعد تعليمي.",
    images: ["/og-image.png"],
  },
  alternates: {
