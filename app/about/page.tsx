      ...
      <main className="max-w-5xl mx-auto px-4 pt-28 pb-16">
        <section className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-slate-600 leading-8">
            نهدف إلى مساعدة التلاميذ على مراجعة الدروس، حل التمارين، والاستعداد للامتحانات بطريقة منظمة وواضحة. تجمع المنصة بين الدروس، التمارين التفاعلية، الامتحانات التجريبية، والمساعدة الذكية باللغة العربية والفرنسية.
          </p>
        </section>
