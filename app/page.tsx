...
const FEATURES = [
  ...
  },
  {
    ...
    desc: "نماذج تدريبية تساعد التلميذ على قياس مستواه، معرفة نقاط الضعف، وتحسين طريقة المراجعة.",
...
const PLANS = [
  ...
  },
  {
    ...
    highlight: true,
    features: ["أسئلة ذكاء اصطناعي غير محدودة", "جميع الدروس والتمارين", "امتحانات تجريبية غير محدودة", "تقارير أسبوعية للأولياء"],
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 pt-24 pb-16 w-full">
          <div className="max-w-2xl">
            ...
            <p className="text-lg md:text-xl text-blue-100 leading-relaxed mb-10 max-w-xl">
              موديريسي منصة تعليمية تساعد تلاميذ الإعدادي المغربي على مراجعة الدروس، حل التمارين، والاستعداد للامتحانات التجريبية بمساعدة ذكية ومنظمة.
            </p>
        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              { step: "03", icon: "📈", title: "المراجعة والتحسن", desc: "يتابع التلميذ تقدمه ويستفيد من المساعد الذكي والامتحانات التجريبية." },
            ].map((item) => (
